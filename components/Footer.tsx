    ...
    <footer className="bg-[#0b1226] text-slate-300">
      <Container className="py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          <div>
            <div className="inline-flex items-center bg-white rounded-md px-4 py-2.5">
              <Image
                src="/sht-logo.png"
                alt="신호테크놀로지"
                width={1160}
            ...
            <p className="mt-5 text-base leading-relaxed text-slate-400 max-w-xs">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-sm text-slate-500">
